      ...
      {cases.map((c, idx) => {
        ...
        return (
          <li
            ...
            className="group relative bg-surface border border-line rounded-[var(--radius-card)] p-5 transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-fg-muted hover:-translate-y-0.5 animate-file-in"
          >
            <span
              aria-hidden
